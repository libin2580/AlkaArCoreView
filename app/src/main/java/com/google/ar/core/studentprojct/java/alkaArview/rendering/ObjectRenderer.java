 ...
 */
package com.google.ar.core.studentprojct.java.alkaArview.rendering;
...
import com.google.ar.core.studentprojct.java.common.rendering.ShaderUtil;
...
public class ObjectRenderer {
   ...
   * Blend mode.
   *
   * @see #setBlendMode(BlendMode) #setBlendMode(BlendMode)
   */
   ...
   * @param specularPower Surface shininess. Larger values result in a smaller, sharper specular     highlight.
   */
   ...
   * @param colorCorrectionRgba the color correction rgba
   * @param colorTintRgba       the color tint rgba
   * @see #setBlendMode(BlendMode) #setBlendMode(BlendMode)
   * @see #updateModelMatrix(float[], float) #updateModelMatrix(float[], float)
   * @see #setMaterialProperties(float, float, float, float) #setMaterialProperties(float, float, float, float)
   * @see android.opengl.Matrix
   */
  public void draw(
      float[] cameraView,
   ...
   * @param cameraPerspective   the camera perspective
   * @param colorCorrectionRgba the color correction rgba
   */
