...
/**
 * Created by Alka Sebastion on 11/06/2018.
 */
...
public class PlaneRenderer {
  ...
  /**
   * Instantiates a new Plane renderer.
   */
  ...
  static class SortablePlane {
    ...
    /**
     * Instantiates a new Sortable plane.
     *
  ...
  /**
   * Calculate distance to plane float.
   *
   * @param planePose  the plane pose
