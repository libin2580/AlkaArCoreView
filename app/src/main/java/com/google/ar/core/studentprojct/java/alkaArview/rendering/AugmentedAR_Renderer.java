 ...
 */
public class AugmentedAR_Renderer {
  private static final String TAG = "AugmentedAR_Renderer";
  ...
  /**
   * Instantiates a new Augmented ar renderer.
   */
  public AugmentedAR_Renderer() {}
   ...
   * @param augmentedImage      the augmented image
   * @param centerAnchor        the center anchor
